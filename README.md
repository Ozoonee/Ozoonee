...
### Я Python backend-разработчик, который пришел в программирование из промышленной автоматизации и IT.
---
...
- 🔭 Сейчас ищу позицию **Junior Python Developer**
- 🌱 Изучаю **FastAPI** и углубляю знания в **алгоритмах**
- 🎯 Цель: стать сильным backend-разработчиком и работать над сложными продуктами
